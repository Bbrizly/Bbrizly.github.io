...
{% comment %} IMAGE: side-by-side of the three building types. {% endcomment %}
...
{% comment %} IMAGE: top-down of a generated map with the sine-wave route highlighted in colour. {% endcomment %}
